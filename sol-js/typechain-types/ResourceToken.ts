...
export interface ResourceTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface ResourceToken extends BaseContract {
  connect(runner?: ContractRunner | null): ResourceToken;
  ...
  filters: {
    ...
    "ResourceBurned(address,uint256,uint256)": TypedContractEvent<
      ResourceBurnedEvent.InputTuple,
      ResourceBurnedEvent.OutputTuple,
      ResourceBurnedEvent.OutputObject
    >;
    ...
    "ResourceMinted(address,uint256,uint256)": TypedContractEvent<
      ResourceMintedEvent.InputTuple,
      ResourceMintedEvent.OutputTuple,
      ResourceMintedEvent.OutputObject
    >;
